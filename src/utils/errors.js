...
/**
 * Throw correct message error from origin in all levels
 * of the structure domain -> adapter -> ports with correct CustomError
 * if the error is typeof CustomError
 * @memberof utils
 * @function
 * @param {Error} error inherited error class
 * @param {string} methodPath  method origin of the error
 * @param {string} classError class of error from our code
 * @return {undefined}
 */
